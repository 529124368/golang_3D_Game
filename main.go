...
type Game struct {
	GameScene, GameScene2    *tetra3d.Scene
...
func NewGame() *Game {
	...
	//
	d, _ = tetra3d.LoadGLTFFile("man.gltf", nil)
	g.GameScene2 = d.ExportedScene
	g.GameScene2.Root.SetLocalPosition(vector.Vector{0, -0.1, 15})
	//声音
	...
	g.Camera.SetLocalPosition(vector.Vector{0, 2.6, 15})
...
func (g *Game) Update() error {
	...
	g.GameScene2.Root.Rotate(0, 1, 0, 0.05)
...
func (g *Game) Draw(screen *ebiten.Image) {
	...
	g.Camera.RenderNodes(g.GameScene2, g.GameScene2.Root)
